...
describe("cds-features-compat-restrict-where rule", () => {
      ...
      invalid: [
        {
          ...
          errors: [{ messageId: "deprecatedCdsFeaturesCompatRestrictWhere", line: 1, column: 23 }],
        },
        {
          code: '{"cds": {"features": {"compat_restrict_where": false}}}',
          filename: "package.json",
          errors: [{ messageId: "deprecatedCdsFeaturesCompatRestrictWhere", line: 1, column: 23 }],
        },
        {
          code: '{"features": {"compat_restrict_where": true}}',
          filename: ".cdsrc.json",
          errors: [{ messageId: "deprecatedCdsFeaturesCompatRestrictWhere", line: 1, column: 15 }],
        },
      ],
    },
  );
